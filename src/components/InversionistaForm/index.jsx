...
import styles from '../ClienteForm/ClienteForm.module.css'

export function InversionistaForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        setError('Error al crear el inversionista')
      }
    } catch (err) {
      const message = err.response?.data?.message || 'Error al crear el inversionista'
      setError(message)
      toast.error(message)
    } finally {
      setLoading(false)
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Completa los datos del inversionista</p>
      </div>
